...
# ==========================================
# 1. 數據核心 (HAA/SAA 真實行情校正版)
# ==========================================
def load_data():
    # 根據 2025/12 - 2026/01 拍賣場真實行情校正
    # 邏輯：Market Price (市場開價) 通常比 Auction Price (拍賣成本) 高約 10%~15%
    data = [
        # --- RAV4 ---
        {
            "brand": "Toyota", "model": "RAV4 (汽油)", "year": "2024/02", 
            "grade": "Grade A", "mileage": "12,500km",
            "market_price": 958000, "auction_price": 865000, # 參考: 新車落地折舊與拍場強勢價格
            "scores": [9, 9, 9, 7, 9], 
            "desc": "HAA 認證 A 級車，幾乎新車。五代 TNGA 底盤操控性極佳。"
        },
        {
            "brand": "Toyota", "model": "RAV4 (油電)", "year": "2021/11", 
            "grade": "Grade A", "mileage": "48,000km",
            "market_price": 830000, "auction_price": 725000, # 參考: 油電二手行情回穩
            "scores": [8, 9, 9, 10, 9], 
            "desc": "油電版熱門車源，SAA 查定結構無損，電池健康度優良。"
        },
        {
            "brand": "Toyota", "model": "RAV4 (汽油)", "year": "2017/05", 
            "grade": "Grade B", "mileage": "95,000km",
            "market_price": 530000, "auction_price": 435000, # 參考: 4.5代行情
            "scores": [10, 8, 7, 6, 8], 
        ...
        # --- Corolla Cross ---
        {
            ...
            "market_price": 810000, "auction_price": 725000, # 參考: 準新車庫存
            "scores": [10, 9, 8, 8, 8], 
        ...
        },
        {
            ...
            "market_price": 660000, "auction_price": 560000, # 參考: 租賃到期車流出價
            "scores": [9, 9, 8, 10, 8], 
        ...
        # --- Altis ---
        {
            ...
            "grade": "Grade A", "mileage": "20,000km",
            "market_price": 630000, "auction_price": 535000, # 參考: 12代熱門款
            "scores": [10, 8, 8, 8, 6], 
            "desc": "12代神車，TNGA 底盤操控大升級。"
        },
        {
            "brand": "Toyota", "model": "Altis", "year": "2017/06", 
            "grade": "Grade B", "mileage": "110,000km",
            "market_price": 320000, "auction_price": 250000, # 參考: 11.5代高里程
            "scores": [10, 7, 6, 7, 6], 
        ...
        # --- Camry ---
        {
            ...
            "grade": "Grade A", "mileage": "55,000km",
            "market_price": 730000, "auction_price": 620000, 
            "scores": [8, 8, 9, 7, 9], 
        ...
        },
        {
            ...
            "market_price": 910000, "auction_price": 810000, 
            "scores": [8, 9, 9, 10, 9], 
        ...
        # --- Yaris & Yaris Cross ---
        {
            ...
            "market_price": 530000, "auction_price": 450000, # 參考: 絕版小鴨極度保值
            "scores": [9, 10, 6, 7, 5], 
            "desc": "絕版品小鴨，市場上掃一台少一台，保值性驚人。"
        },
        {
            "brand": "Toyota", "model": "Yaris Cross", "year": "2024/05", 
            "grade": "Grade S", "mileage": "2,000km",
            "market_price": 720000, "auction_price": 645000, 
            "scores": [9, 9, 7, 8, 8], 
        ...
        # --- Vios ---
        {
            ...
            "market_price": 420000, "auction_price": 350000, 
            "scores": [10, 8, 5, 8, 5], 
        ...
        # --- 商務/MPV (高價差區) ---
        {
            ...
            "market_price": 550000, "auction_price": 485000, 
            "scores": [10, 9, 6, 8, 10], 
            "desc": "買來賺錢的，省下的價差直接當作第一筆創業金。"
        },
        {
            "brand": "Toyota", "model": "Sienta", "year": "2022/05", 
            "grade": "Grade A", "mileage": "30,000km",
            "market_price": 630000, "auction_price": 530000, 
            "scores": [9, 8, 7, 8, 10], 
        ...
        },
        {
            ...
            "market_price": 2080000, "auction_price": 1850000, # 參考: Alphard 價差較大
            "scores": [7, 10, 9, 5, 10], 
        ...
        },
        {
            ...
            "grade": "Grade A", "mileage": "30,000km",
            "market_price": 2250000, "auction_price": 1980000, # 參考: 美規油電高價差
            "scores": [8, 9, 10, 9, 10], 
        ...
        },
        {
            ...
            "market_price": 930000, "auction_price": 810000, 
            "scores": [8, 9, 7, 6, 9], 
            "desc": "絕版子彈列車，正七人座最舒適的第三排，依然搶手。"
        },
        {
            "brand": "Toyota", "model": "Wish", "year": "2016/09", 
            "grade": "Grade B", "mileage": "130,000km",
            "market_price": 420000, "auction_price": 330000, 
            "scores": [9, 8, 6, 7, 9], 
        ...
        # --- 進口/個性 ---
        {
            ...
            "market_price": 640000, "auction_price": 540000, 
            "scores": [7, 8, 8, 8, 6], 
        ...
        },
        {
            ...
            "grade": "Grade A", "mileage": "35,000km",
            "market_price": 690000, "auction_price": 590000, 
            "scores": [8, 8, 9, 8, 6], 
        ...
        },
        {
            ...
            "market_price": 1050000, "auction_price": 880000, # 參考: 電動車折舊較兇
            "scores": [7, 6, 9, 10, 8], 
            "desc": "Toyota 純電休旅，二手折舊大，現在入手CP值最高。"
        },
        {
