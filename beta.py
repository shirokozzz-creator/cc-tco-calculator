...
# ==========================================
def load_data():
    # [cite_start]根據 2025/11-12 拍賣場真實成交紀錄 [cite: 1040, 1052]
    # 策略：展示最熱門的 6 款車，用真實價差吸引客戶
    data = [
        # --- 1. RAV4 (休旅霸主) ---
        {
            "brand": "Toyota", "model": "RAV4 (汽油)", "year": "2020/04", 
            "grade": "Grade A", "mileage": "67,896km",
            [cite_start]"market_price": 750000, "auction_price": 634000, # 真實成交 [cite: 979]
            "scores": [9, 9, 9, 7, 9], 
        ...
        },
        {
            ...
            [cite_start]"market_price": 890000, "auction_price": 748000, # 真實成交 [cite: 980]
            "scores": [8, 9, 9, 10, 9], 
        ...
        # --- 2. Corolla Cross (新神車) ---
        {
            ...
            [cite_start]"market_price": 630000, "auction_price": 500000, # 真實成交 [cite: 1052]
            "scores": [10, 9, 8, 8, 8], 
        ...
        # --- 3. Altis (房車之王) ---
        {
            ...
            [cite_start]"market_price": 430000, "auction_price": 299000, # 真實成交 [cite: 1007]
            "scores": [10, 8, 8, 8, 6], 
        ...
        # --- 4. Camry (進口旗艦) ---
        {
            ...
            [cite_start]"market_price": 750000, "auction_price": 600000, # 真實成交 [cite: 1009]
            "scores": [8, 8, 9, 7, 9], 
        ...
        # --- 5. Vios (國民代步) ---
        {
            ...
            "market_price": 430000, "auction_price": 350000, # 參考行情
            "scores": [10, 8, 5, 8, 5], 
        ...
        # --- 6. Yaris (保值小鴨) ---
        {
            ...
            "market_price": 490000, "auction_price": 390000, # 參考行情
            "scores": [9, 10, 6, 7, 5], 
...
def main():
    ...
    with tab1:
        ...
        if not filtered_df.empty:
            ...
            st.error(f"❌ 抱歉，目前資料庫中暫無「{selected_gen}」的 {db_model_key} 案例。")
